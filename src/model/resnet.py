...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, pretext_classes=512, zero_init_residual=False,
        ...
        self.feat_map_channel = [256 * block.expansion, 512 * block.expansion]
        self.fc = nn.Linear(512 * block.expansion, num_classes)
        self.feat_fc = nn.Linear(512 * block.expansion, pretext_classes)
