...
class BasicBlock_dla(nn.Module):
    def __init__(self, inplanes, planes, stride=1, dilation=1):
        super(BasicBlock_dla, self).__init__()
...
class Bottleneck_dla(nn.Module):
    expansion = 2

    def __init__(self, inplanes, planes, stride=1, dilation=1):
        super(Bottleneck_dla, self).__init__()
...
class DLA(nn.Module):
    def __init__(self, levels, channels, num_classes=1000, pretext_classes=512, 
                 block=BasicBlock_dla, residual_root=False, return_levels=False,
        ...
        self.feat_map_channel = [channels[-1]]
        self.avgpool = nn.AdaptiveAvgPool2d((1, 1))
        #self.avgpool = nn.AvgPool2d(pool_size)
        self.fc = nn.Conv2d(channels[-1], num_classes, kernel_size=1,
                            stride=1, padding=0, bias=True)
        self.feat_fc = nn.Conv2d(channels[-1], pretext_classes, kernel_size=1,
                            stride=1, padding=0, bias=True)
